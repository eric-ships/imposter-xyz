...
export default async function ShareLandingPage({ params }: Props) {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-xl flex-col items-center justify-center gap-8 px-6 py-12">
      ...
      <div className="w-full overflow-hidden rounded-xl border border-line-soft">
        <img
          src={cardUrl}
          alt="Match recap"
          width={1200}
      ...
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <Link
          href="/"
          className="rounded-2xl bg-accent px-6 py-3 text-base font-semibold tracking-tight text-white shadow-sm transition-all duration-100 hover:brightness-110 active:scale-[0.97]"
        >
          Play on Upper
        </Link>
      </div>
